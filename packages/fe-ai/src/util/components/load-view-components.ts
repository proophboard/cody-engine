...
import {views as viewComponents} from "@frontend-ai/app/components/views";
import {views as overwriteViewComponents} from "@frontend-ai/extensions/app/components/views";
